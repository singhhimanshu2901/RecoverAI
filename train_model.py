...
def main():
    ...
    # Only use cases where an action was actually executed and verified
    # (attempt_number >= 1 means execute() ran), so we have a real ground-truth
    # outcome (recovered True/False) to learn from -- regardless of whether
    # the case cycled back to OPEN for another attempt afterward.
